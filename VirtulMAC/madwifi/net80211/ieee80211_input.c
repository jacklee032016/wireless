...
static void ieee80211_saveie(u_int8_t **iep, const u_int8_t *ie)
{
	u_int ielen = ie[1]+2;
	/*
...
#ifdef IEEE80211_DEBUG
static void dump_probe_beacon(u_int8_t subtype, int isnew,
 ...
 */
static void ieee80211_node_pwrsave(struct ieee80211_node *ni, int enable)
{
 ...
 */
static void ieee80211_recv_pspoll(struct ieee80211com *ic,
...
static const u_int8_t * ieee80211_getbssid(struct ieee80211com *ic, const struct ieee80211_frame *wh)
{
	if (ic->ic_opmode == IEEE80211_M_STA)
		return wh->i_addr2;
...
static void ieee80211_discard_frame(struct ieee80211com *ic,	const struct ieee80211_frame *wh,
...
static void ieee80211_discard_ie(struct ieee80211com *ic, const struct ieee80211_frame *wh,
	const char *type, const char *fmt, ...)
{
	va_list ap;
	char buf[512];		// XXX
...
static void ieee80211_discard_mac(struct ieee80211com *ic, const u_int8_t mac[IEEE80211_ADDR_LEN],
	const char *type, const char *fmt, ...)
{
	va_list ap;
	char buf[512];
