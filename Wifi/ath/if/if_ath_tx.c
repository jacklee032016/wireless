/*
* $Id: if_ath_tx.c,v 1.1.1.1 2006/11/30 17:01:51 lizhijie Exp $
 */
...
int ath_tx_start(struct net_device *dev, struct ieee80211_node *ni, struct ath_buf *bf, struct sk_buff *skb)
{
#define	CTS_DURATION \
