/*
* $Id: ieee80211_linux.c,v 1.1.1.1 2006/11/30 17:01:51 lizhijie Exp $
 */
	...
	u_int64_t rsc)
{
	...
	IEEE80211_DPRINTF(ic, IEEE80211_MSG_CRYPTO,
		...
		ether_sprintf(wh->i_addr2), k->wk_cipher->ic_name,	rsc, k->wk_keyrsc);
...
void ieee80211_sysctl_register(struct ieee80211com *ic)
{
	...
	memcpy(&ic->ic_sysctls[4], ieee80211_sysctl_template,	sizeof(ieee80211_sysctl_template));
...
#if WITH_MESH
EXPORT_SYMBOL(mesh_route_dev_create);
EXPORT_SYMBOL(mesh_route_dev_destory);
EXPORT_SYMBOL(mesh_packet_output);
#endif
