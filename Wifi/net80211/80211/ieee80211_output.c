/*
* $Id: ieee80211_output.c,v 1.1.1.1 2006/11/30 17:01:51 lizhijie Exp $
 */
 ...
 */
static int ieee80211_mgmt_output(struct ieee80211com *ic, struct ieee80211_node *ni, struct sk_buff *skb, int type)
{
	...
	*(u_int16_t *)wh->i_seq = htole16(ni->ni_txseqs[0] << IEEE80211_SEQ_SEQ_SHIFT);
	...
	if ((ieee80211_msg_debug(ic) && doprint(ic, type)) || ieee80211_msg_dumppkts(ic))
	{
...
static u_int8_t * ieee80211_setup_wpa_ie(struct ieee80211com *ic, u_int8_t *ie)
{
...
static u_int8_t * ieee80211_setup_rsn_ie(struct ieee80211com *ic, u_int8_t *ie)
{
	static const u_int8_t cipher_suite[][4] = {
...
static u_int8_t *ieee80211_add_wpa(u_int8_t *frm, struct ieee80211com *ic)
{
 ...
 */
static u_int8_t *ieee80211_add_wme_info(u_int8_t *frm, struct ieee80211_wme_state *wme)
{
...
static u_int8_t *ieee80211_add_wme_param(u_int8_t *frm, struct ieee80211_wme_state *wme)
{
