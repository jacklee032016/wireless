/*
* $Id: ieee80211_wireless.c,v 1.1.1.1 2006/11/30 17:01:51 lizhijie Exp $
 */
...
int ieee80211_ioctl_siwmode(struct ieee80211com *ic, struct iw_request_info *info, __u32 *mode, char *extra)
{
	struct ifreq ifr;
	if (!ic->ic_media.ifm_cur)
		return -EINVAL;
...
int ieee80211_ioctl_giwmode(struct ieee80211com *ic, struct iw_request_info *info, __u32 *mode, char *extra)
{
	struct ifmediareq imr;
...
static int ieee80211_ioctl_getstastats(struct ieee80211com *ic, struct iwreq *iwr)
{
	struct ieee80211_node *ni;
...
void ieee80211_ioctl_iwsetup(struct iw_handler_def *def)
{
...
int ieee80211_ioctl(struct ieee80211com *ic, struct ifreq *ifr, int cmd)
{
	switch (cmd)
	{
		case SIOCG80211STATS:
			return copy_to_user(ifr->ifr_data, &ic->ic_stats, sizeof (ic->ic_stats)) ? -EFAULT : 0;
