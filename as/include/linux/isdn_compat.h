...
/*added this line in order to compile hfc-multi.c , lizhijie, 2005.08.02, 
 * refer to include/linux/timer.h 
 */
	typedef	struct timer_list		timer_t;
...
#define pnp_activate_dev(d)		isapnp_activate_dev(d, "AS_ISDN")
