/*
 * $Id: contr.c,v 1.1.1.1 2006/11/29 08:55:13 lizhijie Exp $
 */
...
{
	AS_ISDNinstance_t		*inst = &contr->inst;
...
int
ControllerL3L4(AS_ISDNif_t *hif, struct sk_buff *skb)
{
	Controller_t	*contr;
	Plci_t		*plci;
	int		ret = -EINVAL;
...
int
ControllerConstr(Controller_t **contr_p, AS_ISDNstack_t *st, AS_ISDN_pid_t *pid, AS_ISDNobject_t *ocapi)
{
