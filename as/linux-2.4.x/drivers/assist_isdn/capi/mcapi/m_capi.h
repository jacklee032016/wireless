/* $Id: m_capi.h,v 1.1.1.1 2006/11/29 08:55:13 lizhijie Exp $
 *
...
int		ControllerConstr(Controller_t **, AS_ISDNstack_t *, AS_ISDN_pid_t *, AS_ISDNobject_t *);
...
int		ControllerL3L4(AS_ISDNif_t *, struct sk_buff *);
