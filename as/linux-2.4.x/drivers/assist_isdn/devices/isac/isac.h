/*
 * $Id: isac.h,v 1.1.1.1 2006/11/29 08:55:13 lizhijie Exp $
 */
...
extern int AS_ISDN_isac_init(dchannel_t *);
extern void AS_ISDN_isac_free(dchannel_t *);

extern void AS_ISDN_isac_interrupt(dchannel_t *, u_char);
extern void AS_ISDN_clear_isac(dchannel_t *);
extern int AS_ISDN_ISAC_l1hw(AS_ISDNif_t *, struct sk_buff *);
