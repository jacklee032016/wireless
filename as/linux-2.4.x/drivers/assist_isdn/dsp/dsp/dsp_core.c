/* $Id: dsp_core.c,v 1.1.1.1 2006/11/29 08:55:13 lizhijie Exp $
 * This module does:
 ...
 */
static int
dsp_from_up(AS_ISDNif_t *hif, struct sk_buff *skb)
{
	dsp_t			*dsp;
	AS_ISDN_head_t		*hh;
	int			ret = 0;
 ...
 */
static int
dsp_from_down(AS_ISDNif_t *hif,  struct sk_buff *skb)
{
	dsp_t		*dsp;
	AS_ISDN_head_t	*hh;
	int		ret = 0;
...
{
	AS_ISDNinstance_t	*inst = &dsp->inst;
	conference_t *conf;
 ...
 */
static int
new_dsp(AS_ISDNstack_t *st, AS_ISDN_pid_t *pid) 
{
	int err = 0;
	dsp_t *ndsp;
