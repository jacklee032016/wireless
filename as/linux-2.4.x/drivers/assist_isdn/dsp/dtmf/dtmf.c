/*
 * $Id: dtmf.c,v 1.1.1.1 2006/11/29 08:55:13 lizhijie Exp $
...
static AS_ISDNobject_t dtmf_obj;
...
*/
static int dtmf_from_up(AS_ISDNif_t *hif, struct sk_buff *skb)
{
	dtmf_t		*dtmf;
	AS_ISDN_head_t	*hh;
	int		*data;
...
*/
static int dtmf_from_down(AS_ISDNif_t *hif,  struct sk_buff *skb)
{
	dtmf_t		*dtmf;
	AS_ISDN_head_t	*hh;
...
{
	AS_ISDNinstance_t	*inst = &dtmf->inst;
...
static int new_dtmf(AS_ISDNstack_t *st, AS_ISDN_pid_t *pid)
{
	dtmf_t *n_dtmf;
	int err;
