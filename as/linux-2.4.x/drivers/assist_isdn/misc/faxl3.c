/*
 * $Id: faxl3.c,v 1.1.1.1 2006/11/29 08:55:14 lizhijie Exp $
...
static AS_ISDNobject_t faxl3_obj;
...
send_data_down(faxl3_t *fl3, struct sk_buff *skb) {
	int		ret = 0;
	AS_ISDNif_t	*down = &fl3->inst.down;
...
static int
faxl3_from_up(AS_ISDNif_t *hif, struct sk_buff *skb)
{
	faxl3_t		*faxl3;
	AS_ISDN_head_t	*hh;
	__u32		addr;
...
static int
faxl3_from_down(AS_ISDNif_t *hif,  struct sk_buff *skb)
{
	faxl3_t		*faxl3;
	AS_ISDN_head_t	*hh;
	int		err = 0;
...
release_faxl3(faxl3_t *faxl3) {
	AS_ISDNinstance_t	*inst = &faxl3->inst;
...
static int
new_faxl3(AS_ISDNstack_t *st, AS_ISDN_pid_t *pid) {
	faxl3_t *n_faxl3;
	u8	*p;
	int	err;
