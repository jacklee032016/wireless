/*
 * $Id: i4l_mISDN.c,v 1.1.1.1 2006/11/29 08:55:14 lizhijie Exp $
...
static AS_ISDNobject_t	I4Lcapi;
...
static int
Dchannel_i4l(AS_ISDNif_t *hif, struct sk_buff *skb)
{
	int		i, ret = -EINVAL;
	AS_ISDN_head_t	*hh;
	i4l_capi_t	*ic;
...
static int
Bchannel_i4l(AS_ISDNif_t *hif, struct sk_buff *skb)
{
	i4l_channel_t	*ch;
	int		ret = -EINVAL;
	AS_ISDN_head_t	*hh;
