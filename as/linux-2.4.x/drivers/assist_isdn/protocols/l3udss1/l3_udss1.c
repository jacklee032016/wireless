/*
 * $Id: l3_udss1.c,v 1.1.1.1 2006/11/29 08:55:14 lizhijie Exp $
...
static struct sk_buff *MsgStart(l3_process_t *pc, u_char mt, int len)
{
	struct sk_buff	*skb;
	int		lx = 4;
	u_char		*p;
...
static int l3dss1_message(l3_process_t *pc, u_char mt)
{
	struct sk_buff	*skb;
	int		ret;
...
static void l3dss1_message_cause(l3_process_t *pc, u_char mt, u_char cause)
{
	struct sk_buff	*skb;
	u_char		*p;
	int		ret;
...
static void l3dss1_status_send(l3_process_t *pc, u_char cause)
{
	struct sk_buff	*skb;
	u_char		*p;
	int		ret;
...
static void l3dss1_msg_without_setup(l3_process_t *pc, u_char cause)
{
	...
	switch (cause)
	{
		...
		case 101:	/* incompatible Callstate */
			...
			break;
		default:
			printk(KERN_ERR "AS_ISDN l3dss1_msg_without_setup wrong cause %d\n", cause);
	}
	release_l3_process(pc);
}

/* L3 message used by udss1 defined here */
...
static int ie_in_set(l3_process_t *pc, u_char ie, int *checklist)
{
	int ret = 1;
...
static int check_infoelements(l3_process_t *pc, struct sk_buff *skb, int *checklist)
{
...
* Only NTE-->USER signal is support, so it is only support TE mode
*/
static int l3dss1_check_messagetype_validity(l3_process_t *pc, int mt, void *arg)
{/* Only TE mode */
	switch (mt)
	{
		case MT_ALERTING:
...
static void l3dss1_std_ie_err(l3_process_t *pc, int ret)
{
	if (pc->l3->debug & L3_DEB_CHECK)
...
static int l3dss1_get_channel_id(l3_process_t *pc, struct sk_buff *skb)
{
	Q931_info_t	*qi = (Q931_info_t *)skb->data;
	u_char		*p;
...
static int l3dss1_get_cause(l3_process_t *pc, struct sk_buff *skb)
{
	Q931_info_t	*qi = (Q931_info_t *)skb->data;
	u_char		l;
	u_char		*p;
...
static void l3dss1_release_req(l3_process_t *pc, u_char pr, void *arg)
{
	StopAllL3Timer(pc);
	if (arg)
	{
...
static void l3dss1_setup_req(l3_process_t *pc, u_char pr, void *arg)
{
...
static void l3dss1_disconnect_req(l3_process_t *pc, u_char pr, void *arg)
{
...
static void l3dss1_connect_req(l3_process_t *pc, u_char pr, void *arg)
{
	if (!pc->bc)
	{
		if (pc->l3->debug & L3_DEB_WARN)
...
static void l3dss1_release_cmpl_req(l3_process_t *pc, u_char pr, void *arg)
{
	StopAllL3Timer(pc);
	if (arg)
	{
...
static void l3dss1_alert_req(l3_process_t *pc, u_char pr, void *arg)
{
	if (arg)
	{
		SendMsg(pc, arg, 7);
...
static void l3dss1_proceed_req(l3_process_t *pc, u_char pr, void *arg)
{
	if (arg)
	{
		SendMsg(pc, arg, 9);
...
static void l3dss1_setup_ack_req(l3_process_t *pc, u_char pr, void *arg)
{
	if (arg)
	{
		SendMsg(pc, arg, 25);
...
static void l3dss1_suspend_req(l3_process_t *pc, u_char pr, void *arg)
{
	if (arg)
	{
		SendMsg(pc, arg, 15);
...
static void l3dss1_resume_req(l3_process_t *pc, u_char pr, void *arg)
{
	if (arg)
	{
		SendMsg(pc, arg, 17);
...
static void l3dss1_status_enq_req(l3_process_t *pc, u_char pr, void *arg)
{
	if (arg)
		dev_kfree_skb(arg);
...
static void l3dss1_information_req(l3_process_t *pc, u_char pr, void *arg)
{
	if (pc->state == 2)
	{
		L3DelTimer(&pc->timer);
...
static void l3dss1_notify_req(l3_process_t *pc, u_char pr, void *arg)
{
	if (arg)
	{
		SendMsg(pc, arg, -1);
...
static void l3dss1_progress_req(l3_process_t *pc, u_char pr, void *arg)
{
	if (arg)
	{
		SendMsg(pc, arg, -1);
...
static void l3dss1_release_cmpl(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff	*skb = arg;
...
static void l3dss1_alerting(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff *skb = arg;
	int ret;
...
static void l3dss1_call_proc(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff	*skb = arg;
	int		ret;
	u_char		cause;
...
static void l3dss1_connect(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff	*skb = arg;
	int		ret;
...
static void l3dss1_connect_ack(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff	*skb = arg;
	int		ret;
...
static void l3dss1_disconnect(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff	*skb = arg;
	int		ret;
	u_char		cause = 0;
...
static void l3dss1_setup_ack(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff	*skb = arg;
	int		ret;
	u_char		cause;
...
static void l3dss1_setup(l3_process_t *pc, u_char pr, void *arg)
{
...
static void l3dss1_reset(l3_process_t *pc, u_char pr, void *arg)
{
	release_l3_process(pc);
}

static void l3dss1_release(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff	*skb = arg;
	int		ret, cause=0;
...
static void l3dss1_progress(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff	*skb = arg;
	Q931_info_t	*qi = (Q931_info_t *)skb->data;
	int		err = 0;
...
static void l3dss1_notify(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff	*skb = arg;
	Q931_info_t	*qi = (Q931_info_t *)skb->data;
	int		err = 0;
...
static void l3dss1_status_enq(l3_process_t *pc, u_char pr, void *arg)
{
	int		ret;
	struct sk_buff	*skb = arg;
...
static void l3dss1_information(l3_process_t *pc, u_char pr, void *arg)
{
	int		ret;
	struct sk_buff	*skb = arg;
...
static void l3dss1_release_ind(l3_process_t *pc, u_char pr, void *arg)
{
	u_char		*p;
	struct sk_buff	*skb = arg;
	int		err, callState = -1;
...
static void l3dss1_restart(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff	*skb = arg;
	L3DelTimer(&pc->timer);
...
static void l3dss1_status(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff	*skb = arg;
	Q931_info_t	*qi = (Q931_info_t *)skb->data;
	int		ret = 0; 
...
static void l3dss1_facility(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff	*skb = arg;
	Q931_info_t	*qi = (Q931_info_t *)skb->data;
	int		ret;
...
static void l3dss1_suspend_ack(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff	*skb = arg;
	int		ret;
...
static void l3dss1_suspend_rej(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff	*skb = arg;
	int		ret;
	u_char		cause;
...
static void l3dss1_resume_ack(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff	*skb = arg;
	int		ret;
...
static void l3dss1_resume_rej(l3_process_t *pc, u_char pr, void *arg)
{
	struct sk_buff	*skb = arg;
	int		ret;
	u_char		cause;
...
static void l3dss1_global_restart(l3_process_t *pc, u_char pr, void *arg)
{
...
static void l3dss1_dummy(l3_process_t *pc, u_char pr, void *arg)
{
}

static void l3dss1_t302(l3_process_t *pc, u_char pr, void *arg)
{
	L3DelTimer(&pc->timer);
	newl3state(pc, 11);
...
static void l3dss1_t303(l3_process_t *pc, u_char pr, void *arg)
{
	L3DelTimer(&pc->timer);
	if (pc->n303 > 0)
	{
...
static void l3dss1_t304(l3_process_t *pc, u_char pr, void *arg)
{
	L3DelTimer(&pc->timer);
	newl3state(pc, 11);
...
static void l3dss1_t305(l3_process_t *pc, u_char pr, void *arg)
{
	L3DelTimer(&pc->timer);
#if 0
...
static void l3dss1_t310(l3_process_t *pc, u_char pr, void *arg)
{
	L3DelTimer(&pc->timer);
	newl3state(pc, 11);
	l3dss1_message_cause(pc, MT_DISCONNECT, CAUSE_TIMER_EXPIRED);
...
static void l3dss1_t313(l3_process_t *pc, u_char pr, void *arg)
{
	L3DelTimer(&pc->timer);
	newl3state(pc, 11);
	l3dss1_message_cause(pc, MT_DISCONNECT, CAUSE_TIMER_EXPIRED);
...
static void l3dss1_t308_1(l3_process_t *pc, u_char pr, void *arg)
{
	newl3state(pc, 19);
	L3DelTimer(&pc->timer);
	l3dss1_message(pc, MT_RELEASE);
...
static void l3dss1_t308_2(l3_process_t *pc, u_char pr, void *arg)
{
	L3DelTimer(&pc->timer);
	AS_ISDN_l3up(pc, CC_TIMEOUT | INDICATION, NULL);
	release_l3_process(pc);
...
static void l3dss1_t318(l3_process_t *pc, u_char pr, void *arg)
{
	L3DelTimer(&pc->timer);
#if 0
...
static void l3dss1_t319(l3_process_t *pc, u_char pr, void *arg)
{
	L3DelTimer(&pc->timer);
#if 0
	pc->cause = 102;	/* Timer expiry */
...
static void l3dss1_dl_reset(l3_process_t *pc, u_char pr, void *arg)
{
...
static void l3dss1_dl_release(l3_process_t *pc, u_char pr, void *arg)
{
	newl3state(pc, 0);
#if 0
...
static void l3dss1_dl_reestablish(l3_process_t *pc, u_char pr, void *arg)
{
	L3DelTimer(&pc->timer);
...
static void l3dss1_dl_reest_status(l3_process_t *pc, u_char pr, void *arg)
{
	L3DelTimer(&pc->timer);
...
static struct stateentry downstatelist[] =
{
	...
	{ALL_STATES,			CC_NOTIFY | REQUEST, 				l3dss1_notify_req},
	{SBIT(10),			CC_PROGRESS | REQUEST, 				l3dss1_progress_req},
	{SBIT(0),			CC_RESUME | REQUEST, 				l3dss1_resume_req},
	{SBIT(1) | SBIT(2) | SBIT(3) | SBIT(4) | SBIT(6) | SBIT(7) |
		SBIT(8) | SBIT(9) | SBIT(10) | SBIT(25),
						CC_DISCONNECT | REQUEST, 			l3dss1_disconnect_req},
	{SBIT(11) | SBIT(12),	CC_RELEASE | REQUEST, 				l3dss1_release_req},
	{ALL_STATES,			CC_RESTART | REQUEST, 				l3dss1_restart},
	{SBIT(6) | SBIT(25),	CC_SETUP | RESPONSE, 				l3dss1_release_cmpl_req},
	{ALL_STATES,			CC_RELEASE_COMPLETE | REQUEST, 		l3dss1_release_cmpl_req},
	{SBIT(6) | SBIT(25),	CC_PROCEEDING | REQUEST, 			l3dss1_proceed_req},
	{SBIT(6),			CC_SETUP_ACKNOWLEDGE | REQUEST, 	l3dss1_setup_ack_req},
	{SBIT(25),			CC_SETUP_ACKNOWLEDGE | REQUEST, 	l3dss1_dummy},
	{SBIT(6) | SBIT(9) | SBIT(25),
						CC_ALERTING | REQUEST, 				l3dss1_alert_req},
	{SBIT(6) | SBIT(7) | SBIT(9) | SBIT(25),
						CC_CONNECT | REQUEST, 				l3dss1_connect_req},
	{SBIT(10),			CC_SUSPEND | REQUEST, 				l3dss1_suspend_req},
	{ALL_STATES,			CC_STATUS_ENQUIRY | REQUEST, 		l3dss1_status_enq_req},
};
...
{
	{ALL_STATES,			MT_STATUS_ENQUIRY, 				l3dss1_status_enq},
	{ALL_STATES,			MT_FACILITY, 					l3dss1_facility},
	{SBIT(19),			MT_STATUS, 						l3dss1_release_ind},
	{ALL_STATES,			MT_STATUS, 						l3dss1_status},
	{SBIT(0),			MT_SETUP, 						l3dss1_setup},
	{SBIT(6) | SBIT(7) | SBIT(8) | SBIT(9) | SBIT(10) | SBIT(11) | SBIT(12) |
	 SBIT(15) | SBIT(17) | SBIT(19) | SBIT(25),	 MT_SETUP, 	l3dss1_dummy},
	{SBIT(1) |SBIT(2), 	MT_CALL_PROCEEDING, 			l3dss1_call_proc},
	{SBIT(1),			MT_SETUP_ACKNOWLEDGE, 			l3dss1_setup_ack},
	{SBIT(2) | SBIT(3),	MT_ALERTING, 					l3dss1_alerting},
	{SBIT(2) | SBIT(3),	MT_PROGRESS, 					l3dss1_progress},
	{SBIT(2) | SBIT(3) | SBIT(4) | SBIT(7) | SBIT(8) | SBIT(9) | SBIT(10) |
	 SBIT(11) | SBIT(12) | SBIT(15) | SBIT(17) | SBIT(19) | SBIT(25),
						MT_INFORMATION, 				l3dss1_information},
	{ALL_STATES,			MT_NOTIFY, 						l3dss1_notify},
	...
	{SBIT(19),			MT_DISCONNECT, 					l3dss1_dummy},
	{SBIT(1) | SBIT(2) | SBIT(3) | SBIT(4),	 MT_CONNECT, 	l3dss1_connect},
	{SBIT(8),			MT_CONNECT_ACKNOWLEDGE, 		l3dss1_connect_ack},
	{SBIT(15),			MT_SUSPEND_ACKNOWLEDGE, 		l3dss1_suspend_ack},
	{SBIT(15),			MT_SUSPEND_REJECT, 				l3dss1_suspend_rej},
	{SBIT(17),			MT_RESUME_ACKNOWLEDGE, 		l3dss1_resume_ack},
	{SBIT(17),			MT_RESUME_REJECT, 				l3dss1_resume_rej},
};
...
{
	{ALL_STATES, 	MT_STATUS, 		l3dss1_status},
	{SBIT(0),		MT_RESTART, 	l3dss1_global_restart},
/*	{SBIT(1),		MT_RESTART_ACKNOWLEDGE, l3dss1_restart_ack},
*/
};
#define GLOBALM_LEN \
...
{/*    state                           primitive                              handler */
	{SBIT(2),		DL_ESTABLISH | INDICATION, 	l3dss1_dl_reset},
	{SBIT(10),		DL_ESTABLISH | CONFIRM, 		l3dss1_dl_reest_status},
	{SBIT(10),		DL_RELEASE | INDICATION, 	l3dss1_dl_reestablish},
	{ALL_STATES,		DL_RELEASE | INDICATION, 	l3dss1_dl_release},
	{SBIT(25),		CC_T302, 					l3dss1_t302},
	{SBIT(1),		CC_T303, 					l3dss1_t303},
	{SBIT(2),		CC_T304, 					l3dss1_t304},
	{SBIT(3),		CC_T310, 					l3dss1_t310},
	{SBIT(8),		CC_T313, 					l3dss1_t313},
	{SBIT(11),		CC_T305, 					l3dss1_t305},
	{SBIT(15),		CC_T319, 					l3dss1_t319},
	{SBIT(17),		CC_T318, 					l3dss1_t318},
	{SBIT(19),		CC_T308_1, 					l3dss1_t308_1},
	{SBIT(19),		CC_T308_2, 					l3dss1_t308_2},
	{SBIT(10),		CC_T309, 					l3dss1_dl_release},
	{SBIT(6),		CC_TCTRL, 					l3dss1_reset},
	{ALL_STATES,		CC_RESTART | REQUEST, 		l3dss1_restart},
};
...
static void global_handler(layer3_t *l3, u_int mt, struct sk_buff *skb)
{
	u_int		i;
	...
	if (i == GLOBALM_LEN)
	{
		...
		{
			l3_debug(l3, "dss1 global state %d mt %x unhandled", proc->state, mt);
		}
	...
	else
	{
		if (l3->debug & L3_DEB_STATE)
		{
			l3_debug(l3, "dss1 global %d mt %x", proc->state, mt);
		}
...
static int dss1_fromdown(AS_ISDNif_t *hif, struct sk_buff *skb)
{
	layer3_t			*l3;
	u_int			i;
	...
	if (skb->data[0] != PROTO_DIS_EURO)
	{
		...
		{
			l3_debug(l3, "%s : FROMDOWN %sunexpected discriminator %x message len %d", l3->inst.name,
				 (hh->prim == (DL_DATA | INDICATION)) ? " " : "(broadcast) ", skb->data[0], skb->len);
		}
		dev_kfree_skb(skb);
		spin_unlock_irqrestore(&l3->lock, flags);
		return(0);
		...
		if (i == DATASLLEN)
		{
			if (l3->debug & L3_DEB_STATE)
			{
				l3_debug(l3, "dss1up%sstate %d mt %#x unhandled",
					(hh->prim == (DL_DATA | INDICATION)) ? " " : "(broadcast) ", proc->state, qi->type);
			}
...
static int dss1_fromup(AS_ISDNif_t *hif, struct sk_buff *skb)
{
	layer3_t	*l3;
	u_int		i;
	int		cr, ret = -EINVAL;
	...
	if (!proc)
	{
		printk(KERN_ERR "ISDN dss1 fromup without proc pr=%04x\n", hh->prim);
		spin_unlock_irqrestore(&l3->lock, flags);
		return(-EINVAL);
	}
	...
	for (i = 0; i < DOWNSLLEN; i++)
	{
		...
		if (i == DOWNSLLEN)
		{
			if (l3->debug & L3_DEB_STATE)
			{
				l3_debug(l3, "dss1down state %d prim %#x unhandled", proc->state, hh->prim);
			}
			dev_kfree_skb(skb);
		}
		else
		{
			if (l3->debug & L3_DEB_STATE)
			{
				l3_debug(l3, "dss1down state %d prim %#x para len %d", proc->state, hh->prim, skb->len);
			}
			/* pass data/primitive down to low layer */
			if (skb->len)
...
*/
static int dss1man(l3_process_t *proc, u_int pr, void *arg)
{
	u_int	i;
 
	if (!proc)
	{
		printk(KERN_ERR "AS_ISDN dss1man without proc pr=%04x\n", pr);
		return(-EINVAL);
	}
	...
	for (i = 0; i < MANSLLEN; i++)
	{
		...
		if (i == MANSLLEN)
		{
			...
			{
				l3_debug(proc->l3, "cr %d dss1man state %d prim %#x unhandled", proc->callref & 0x7fff, proc->state, pr);
			}
		}
		else
		{
			if (proc->l3->debug & L3_DEB_STATE)
			{
				l3_debug(proc->l3, "cr %d dss1man state %d prim %#x", proc->callref & 0x7fff, proc->state, pr);
			}
...
static void release_udss1(layer3_t *l3)
{
	AS_ISDNinstance_t  *inst = &l3->inst;
	u_long		flags;
...
static int new_udss1(AS_ISDNstack_t *st, AS_ISDN_pid_t *pid)
{
	layer3_t	*nl3;
	int		err;
	...
	{
		printk(KERN_ERR "UDSS1-MGR : kmalloc layer3 failed\n");
		return(-ENOMEM);
	}
	memset(nl3, 0, sizeof(layer3_t));
	memcpy(&nl3->inst.pid, pid, sizeof(AS_ISDN_pid_t));
	nl3->debug = asl3_debug;
	AS_ISDN_init_instance(&nl3->inst, &u_dss1, nl3);
	if (!AS_ISDN_SetHandledPID(&u_dss1, &nl3->inst.pid))
	{
		int_error();
		return(-ENOPROTOOPT);
	}
	...
	{
		printk(KERN_ERR "UDSS1-MGR : create failed prt %x\n", pid->protocol[3]);
		kfree(nl3);
		return(-ENOPROTOOPT);
	}
	...
	{
		printk(KERN_ERR "UDSS1-MGR : can't get memory for dss1 global CR\n");
		release_l3(nl3);
		kfree(nl3);
		return(-ENOMEM);
	}
	...
	{
		printk(KERN_ERR "UDSS1-MGR : can't get memory for dss1 dummy CR\n");
		release_l3(nl3);
		kfree(nl3);
		return(-ENOMEM);
	}
	...
	sprintf(nl3->inst.name, "UDSS1-%d", st->id);
	...
	if (err)
	{
		printk(KERN_WARNING "UDSS1-MGR : MGR_NEWENTITY REQUEST failed err(%x)\n", err);
	}
...
static int udss1_manager(void *data, u_int prim, void *arg)
{
	...
	if (asl3_debug & 0x1000)
		printk(KERN_DEBUG "UDSS1-MGR : data:%p(inst:%s) prim:%x arg:%p--%s\n", data, inst->name, prim, arg, inst->name);
	...
	{
		if (asl3_debug & 0x1)
			printk(KERN_WARNING "UDSS1-MGR : prim(%x) no instance\n", prim);
		return(-EINVAL);
	}
	...
	switch(prim)
	{
		...
		case MGR_SETIF | INDICATION:
			return(AS_ISDN_SetIF(inst, arg, prim, dss1_fromup, dss1_fromdown, l3l));
		...
		case MGR_UNREGLAYER | REQUEST:
			if (asl3_debug & 0x1000)
				printk(KERN_DEBUG "UDSS1-MGR : release_udss1 id %x\n", l3l->inst.st->id);
			release_udss1(l3l);
			break;
		...
		default:
			if (asl3_debug & 0x1)
				printk(KERN_WARNING "UDSS1-MGR : prim %x not handled\n", prim);
		return(-EINVAL);
	}
	return(0);
}
...
int UDSS1Init(void)
{
	...
	printk(KERN_INFO AS_VERSION_INFO("DSS1 Rev") );
#ifdef MODULE
	...
	u_dss1.DPROTO.protocol[3] = ISDN_PID_L3_DSS1USER |
		ISDN_PID_L3_DF_PTP |	ISDN_PID_L3_DF_EXTCID |ISDN_PID_L3_DF_CRLEN2;
	u_dss1.own_ctrl = udss1_manager;
	AS_ISDNl3New();
	if ((err = as_isdn_register(&u_dss1)))
	{
...
void UDSS1_cleanup(void)
{
	...
	if ((err = as_isdn_unregister(&u_dss1)))
	{
		printk(KERN_ERR "Can't unregister %s error(%d)\n", u_dss1.name, err);
	}

	if (!list_empty(&u_dss1.ilist))
	{
		printk(KERN_WARNING "AS ISDNl3 u_dss1 list not empty\n");
