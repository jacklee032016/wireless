/*
 * $Id: layer3.h,v 1.1.1.1 2006/11/29 08:55:14 lizhijie Exp $
 */
...
typedef struct _layer3
{
	...
	l3_process_t			*global;
	l3_process_t			*dummy;
	int					(*p_mgr)(l3_process_t *, u_int, void *);	/* handler for l3_process_t in Layer3 management entity,point to dss1man  */
	int					down_headerlen;
	u_int				id;
	int					debug;
	u_long				Flag;
