/*
 * $Id: l3_fsm.c,v 1.1.1.1 2006/11/29 08:55:14 lizhijie Exp $
...
static inline int my_l3_if_link(AS_ISDNif_t *i, u_int prim, int dinfo, int len, void *arg, int reserve)
{
	struct sk_buff	*skb;
	int		err =0;
...
static inline int my_l3_if_newhead(AS_ISDNif_t *i, u_int prim, int dinfo, struct sk_buff *skb)
{
//	TRACE();
	if (!i->func || !skb)
	{
