 ...
 *
 *	$Id: fwd_ioctl.c,v 1.1.1.1 2006/11/30 17:00:40 lizhijie Exp $
 *
			   ...
			   unsigned long arg2)
{
	...
	case BRCTL_GET_BRIDGE_INFO:
	{
		...
		b.hello_timer_value = fwd_timer_get_residue(&br->hello_timer);
		b.tcn_timer_value = fwd_timer_get_residue(&br->tcn_timer);
		b.topology_change_timer_value = fwd_timer_get_residue(&br->topology_change_timer);
		b.gc_timer_value = fwd_timer_get_residue(&br->gc_timer);
	...
	case BRCTL_GET_PORT_INFO:
	{
		...
		p.message_age_timer_value = fwd_timer_get_residue(&pt->message_age_timer);
		p.forward_delay_timer_value = fwd_timer_get_residue(&pt->forward_delay_timer);
		p.hold_timer_value = fwd_timer_get_residue(&pt->hold_timer);
	...
	case BRCTL_GET_FDB_ENTRIES:
		return mesh_fwd_db_get_entries(br, (void *)arg0, arg1, arg2);
	}
