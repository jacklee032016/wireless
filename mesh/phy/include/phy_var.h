/*
* $Id: phy_var.h,v 1.1.1.1 2006/11/30 17:00:40 lizhijie Exp $
*/

/* Defintions for the Atheros Wireless LAN controller driver. */
#ifndef __PHY_VAR_H__
#define __PHY_VAR_H__
...
struct ath_softc
{
	...
	void						(*sc_recv_mgmt)(struct ieee80211com *, struct sk_buff *, struct ieee80211_node *, int, int, u_int32_t);
	int						(*sc_newstate)(struct ieee80211com *,	enum ieee80211_state, int);
	void 					(*sc_node_free)(struct ieee80211_node *);
	
	void						*sc_bdev;	/* associated bus device : pci_device */
	...
	struct meshw_statistics	sc_iwstats;	/* wireless statistics block */
...
int	_phy_media_change(MESH_DEVICE *);

int	_phy_attach(u_int16_t, MESH_DEVICE *);
int	_phy_detach(MESH_DEVICE *);

#ifdef CONFIG_PM
void	ath_resume(MESH_DEVICE *);
void	ath_suspend(MESH_DEVICE *);
void	ath_shutdown(MESH_DEVICE *);
#endif
