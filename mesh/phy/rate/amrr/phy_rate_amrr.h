/*
* $Id: phy_rate_amrr.h,v 1.1.1.1 2006/11/30 17:00:40 lizhijie Exp $
*/

#ifndef __PHY_RATE_AMRR_H__
#define __PHY_RATE_AMRR_H__
...
extern	int ath_rate_max_success_threshold;
extern	int ath_rate_min_success_threshold;
