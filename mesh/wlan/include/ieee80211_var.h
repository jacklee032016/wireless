/*
* $Id: ieee80211_var.h,v 1.1.1.1 2006/11/30 17:00:40 lizhijie Exp $
 */
 
#ifndef _NET80211_IEEE80211_VAR_H_
#define _NET80211_IEEE80211_VAR_H_

#define	WITH_SUPPORT_STA			0
/*
...
struct ieee80211com
{
	...
	int						(*ic_init)(MESH_DEVICE *);
	int						(*ic_reset)(MESH_DEVICE *);
	
	void						(*ic_recv_mgmt)(struct ieee80211com *,  struct sk_buff *, struct ieee80211_node *,   int, int, u_int32_t);
	int						(*ic_send_mgmt)(struct ieee80211com *,  struct ieee80211_node *, int, int);
	...
	void						(*ic_updateslot)(MESH_DEVICE *);
	void						(*ic_set_tim)(struct ieee80211com *,   struct ieee80211_node *, int);
	...
	struct sk_buff_head			ic_mgtq;			/* manage frame queue */
	...
	u_int16_t						ic_sta_assoc;	/* number of stations associated */
	...
	struct wlan_ifmedia				ic_media;	/* interface media config */
#if NBPFILTER > 0
	struct bpf_if		*ic_rawbpf;	/* packet filter structure */
#endif

	struct ieee80211_node			*ic_bss;			/* information for BSSID node, STA mode, it is AP; AdHoc/AP, it is myself  */
...
void	ieee80211_media_init(struct ieee80211com *,
		wlan_ifm_change_cb_t, wlan_ifm_stat_cb_t);
struct ieee80211com *ieee80211_find_vap(const u_int8_t mac[IEEE80211_ADDR_LEN]);
int	ieee80211_media_change(MESH_DEVICE *);
void	ieee80211_media_status(MESH_DEVICE *, struct wlan_ifmediareq *);
int	wlan_ioctl(struct ieee80211com *, unsigned long data, int);
...
#if WITH_MESH
#define	IEEE80211_MSG_MESH			0x00000200	/* MESH, 11s */
#endif
...
#if WITH_MESH
#define	ieee80211_msg_mesh(_ic) \
	((_ic)->ic_debug & IEEE80211_MSG_MESH)
#endif
