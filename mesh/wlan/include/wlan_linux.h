/*
* $Id: wlan_linux.h,v 1.1.1.1 2006/11/30 17:00:40 lizhijie Exp $
 */
 
#ifndef __WLAN_LINUX_H__
#define __WLAN_LINUX_H__
...
static inline void *ieee80211_malloc(size_t size, int flags)
{
...
struct ieee80211com;
extern	void mdev_printf(MESH_DEVICE *, const char *, ...);
...
extern	MESH_DEVICE_STATS *ieee80211_getstats(MESH_DEVICE *);
...
extern	void ieee80211_iw_getstats(struct ieee80211com*, struct meshw_statistics*);
struct meshw_request_info;
struct meshw_point;
extern	int ieee80211_ioctl_giwname(struct ieee80211com *,
		struct meshw_request_info *, char *name, char *extra);
extern	int ieee80211_ioctl_siwencode(struct ieee80211com *,
		struct meshw_request_info *, struct meshw_point *, char *);
extern	int ieee80211_ioctl_giwencode(struct ieee80211com *,
		struct meshw_request_info *, struct meshw_point *, char *key);
struct meshw_param;
extern	int ieee80211_ioctl_siwrate(struct ieee80211com *,
		struct meshw_request_info *, struct meshw_param *, char *);
...
extern	int ieee80211_ioctl_siwap(struct ieee80211com *,
		struct meshw_request_info *, struct sockaddr *, char *);
...
extern	int ieee80211_ioctl_siwfreq(struct ieee80211com *,
		struct meshw_request_info *, struct meshw_freq *, char *);
...
extern	int ieee80211_ioctl_siwmode(struct ieee80211com *,
		struct meshw_request_info *, __u32 *, char *);
...
extern	int ieee80211_ioctl_setparam(struct ieee80211com *,
		struct meshw_request_info *, void *, char *);
...
extern	void ieee80211_ioctl_iwsetup(struct meshw_handler_def *);
