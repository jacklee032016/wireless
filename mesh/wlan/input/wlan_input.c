/*
* $Id: wlan_input.c,v 1.1.1.1 2006/11/30 17:00:40 lizhijie Exp $
*/
...
ktrace;
				...
				/* every data frame no matter dest address is send to mesh fwd operations, 
				* so commented this line. lizhijie,2006.10.09  */
...
ktrace;
				 ...
				 */
				if (ni == ic->ic_bss && ic->ic_opmode != IEEE80211_M_HOSTAP)
				{
					/*
					 * Fake up a node for this newly
					 * discovered member of the IBSS.
					 */
					IEEE80211_DPRINTF(ic, IEEE80211_MSG_INPUT, "[%s] creating adhoc node for data frame\n", swjtu_mesh_mac_sprintf(wh->i_addr2));
...
ktrace;
			return _ieee80211_input_data( ic, skb,  ni, rssi, rstamp);

		case IEEE80211_FC0_TYPE_MGT:
			return _ieee80211_input_mgmt(ic, skb, ni, rssi, rstamp);
