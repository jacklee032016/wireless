/*
 *	Wireless Tools
 * Main code for "iwconfig". This is the generic tool for most manipulations...
 */
		 ...
		 int		count)		/* Args count */
{
  ...
  if(!strcasecmp(args[0], "auto"))
      ...
      else			/* Should be a numeric value */
	{
	  ...
	  if(index(args[0], 'G')) brate *= GIGA;
	  if(index(args[0], 'M')) brate *= MEGA;
	  if(index(args[0], 'k')) brate *= KILO;
