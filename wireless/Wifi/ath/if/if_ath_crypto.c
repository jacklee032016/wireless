/*
* $Id: if_ath_crypto.c,v 1.1.1.1 2006/11/30 17:01:51 lizhijie Exp $
 */
...
void ath_initkeytable(struct ath_softc *sc)
{
 ...
 */
static u_int16_t key_alloc_2pair(struct ath_softc *sc)
{
#define	N(a)	(sizeof(a)/sizeof(a[0]))
	u_int i, keyix;
...
static u_int16_t key_alloc_single(struct ath_softc *sc)
{
#define	N(a)	(sizeof(a)/sizeof(a[0]))
	u_int i, keyix;
