/*
 * $Id: ah_osdep.c,v 1.1.1.1 2006/11/30 17:01:51 lizhijie Exp $
 */
#include "opt_ah.h"

/* this file will be copy into ath_hal directory when open HAL is not used */
...
void ath_hal_sysctl_register(void)
{
	static int initialized = 0;

	if (!initialized)
	{
		ath_hal_sysctl_header = register_sysctl_table(ath_root_table, 1);
		initialized = 1;
	}
}

void ath_hal_sysctl_unregister(void)
{
