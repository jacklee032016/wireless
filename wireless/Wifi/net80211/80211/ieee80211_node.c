/*
* $Id: ieee80211_node.c,v 1.1.1.1 2006/11/30 17:01:51 lizhijie Exp $
 */
 ...
 */
static inline void ieee80211_set_chan(struct ieee80211com *ic,
...
static void dump_chanlist(const u_char chans[])
{
	const char *sep;
	int i;
 ...
 */
static void ieee80211_reset_scan(struct ieee80211com *ic)
{
...
static int ieee80211_match_bss(struct ieee80211com *ic, struct ieee80211_node *ni)
{
        u_int8_t rate;
        int fail;
...
static __inline u_int8_t maxrate(const struct ieee80211_node *ni)
{
...
int ieee80211_ibss_merge(struct ieee80211com *ic, struct ieee80211_node *ni)
{
	...
	printk("%s: ibss merge: %s", ic->ic_dev->name, ether_sprintf(ic->ic_bss->ni_bssid));
	printk(" -> %s\n", ether_sprintf(ni->ni_bssid));
...
static struct ieee80211_node *node_alloc(struct ieee80211_node_table *nt)
{
	struct ieee80211_node *ni;
 ...
 */
static void node_cleanup(struct ieee80211_node *ni)
{
...
static void ieee80211_setup_node(struct ieee80211_node_table *nt,
...
static void _ieee80211_free_node(struct ieee80211_node *ni)
{
	struct ieee80211com *ic = ni->ni_ic;
	...
	IEEE80211_DPRINTF(ic, IEEE80211_MSG_NODE,
		"%s %p<%s> in %s table\n", __func__, ni,
		ether_sprintf(ni->ni_macaddr), nt != NULL ? nt->nt_name : "<gone>");
...
static void ieee80211_free_allnodes_locked(struct ieee80211_node_table *nt)
{
	struct ieee80211com *ic = nt->nt_ic;
	struct ieee80211_node *ni;
...
static void ieee80211_free_allnodes(struct ieee80211_node_table *nt)
{
	IEEE80211_NODE_LOCK(nt);
...
static void ieee80211_timeout_scan_candidates(struct ieee80211_node_table *nt)
{
	struct ieee80211com *ic = nt->nt_ic;
...
static void ieee80211_set_tim(struct ieee80211com *ic, struct ieee80211_node *ni, int set)
{
	u_int16_t aid;
...
void ieee80211_node_attach(struct ieee80211com *ic)
{
	...
	ieee80211_node_table_init(ic, &ic->ic_sta, "station",	IEEE80211_INACT_INIT, ieee80211_timeout_stations);
	ieee80211_node_table_init(ic, &ic->ic_scan, "scan",	IEEE80211_INACT_SCAN, ieee80211_timeout_scan_candidates);
