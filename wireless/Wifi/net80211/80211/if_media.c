/*
* $Id: if_media.c,v 1.1.1.1 2006/11/30 17:01:51 lizhijie Exp $
 */
 ...
 */
void ifmedia_init( struct ifmedia *ifm,
	int dontcare_mask,
 ...
 */
int ifmedia_ioctl(dev, ifr, ifm, cmd)
	...
	u_long cmd;
{
	...
	case  SIOCSIFMEDIA:
	{
		...
		error = (*ifm->ifm_change)(dev);	/* callback */
		if (error)
		{
