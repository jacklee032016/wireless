/*
* $Id: ieee80211_input_mgmt.c,v 1.1.1.1 2006/11/30 17:01:51 lizhijie Exp $
*/
...
void __associate_request(struct ieee80211com *ic, struct sk_buff *skb,
	struct ieee80211_node *ni,	int subtype, int rssi, u_int32_t rstamp)
{
...
void __probe_request(struct ieee80211com *ic, struct sk_buff *skb,
	struct ieee80211_node *ni,	int subtype, int rssi, u_int32_t rstamp)
{
		u_int8_t rate;
...
void __beacon_probe_response(struct ieee80211com *ic, struct sk_buff *skb,
	struct ieee80211_node *ni,	int subtype, int rssi, u_int32_t rstamp)
{
...
void ieee80211_recv_mgmt(struct ieee80211com *ic, struct sk_buff *skb,
	struct ieee80211_node *ni,	int subtype, int rssi, u_int32_t rstamp)
{
	struct ieee80211_frame *wh;
	u_int8_t *frm, *efrm;
...
int ieee80211_input_mgmt(struct ieee80211com *ic, struct sk_buff *skb, struct ieee80211_node *ni, int rssi, u_int32_t rstamp)
{
	...
	if ((ieee80211_msg_debug(ic) && doprint(ic, subtype)) ||ieee80211_msg_dumppkts(ic))
	{
		if_printf(ic->ic_dev, "received %s from %s rssi %d\n", ieee80211_mgt_subtype_name[subtype >>
			IEEE80211_FC0_SUBTYPE_SHIFT], ether_sprintf(wh->i_addr2), rssi);
	}
#endif
