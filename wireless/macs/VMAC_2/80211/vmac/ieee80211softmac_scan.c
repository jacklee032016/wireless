...
int ieee80211softmac_start_scan(struct ieee80211softmac_device *sm)
{
	unsigned long flags;
	int ret;
...
void ieee80211softmac_stop_scan(struct ieee80211softmac_device *sm)
{
	unsigned long flags;
...
void ieee80211softmac_wait_for_scan(struct ieee80211softmac_device *sm)
{
	unsigned long flags;
