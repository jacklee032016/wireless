 ...
 * to demonstrate VMAC features. It does not do packet ACKs as required
 ...
 */
void *cu_softmac_cheesymac_new_instance(void *layerpriv);

/**
 *  Dereference a macinfo pointer and deallocate the instance if the
 * reference count becomes zero.
 */
void cu_softmac_cheesymac_free_instance(void *layerpriv, void* macinfo);

/**
 *  Initialize 'macpriv' with default CheesyMAC function pointers
 */
void cu_softmac_cheesymac_set_macinfo_functions(vmac_mac_t* macpriv);
 ...
 */
void cu_softmac_cheesymac_get_instance_params(void* macpriv,
					 CU_SOFTMAC_CHEESYMAC_PARAMETERS* params);

/**
 *  Set the parameters of a specific CheesyMAC instance
 */
void cu_softmac_cheesymac_set_instance_params(void* macpriv,
					 CU_SOFTMAC_CHEESYMAC_PARAMETERS* params);
